...
class VTK_OT_Data_range_all_frames(bpy.types.Operator):  # noqa: N801
    """Data range over all time steps."""
...
class VTK_OT_Data_range_current_frame(bpy.types.Operator):  # noqa: N801
    """Data range of the current frame."""
...
class VTK_OT_Data_range_custom(bpy.types.Operator):  # noqa: N801
    """Custom data range."""
...
class MATERIAL_PT_VTK_Attributes(bpy.types.Panel):  # noqa: N801
    """Material panel."""
...
def get_availbale_colormaps() -> list[str]:
...
def vtk_enum_attribute_component(
    self,
    context: bpy.types.Context,
) -> list[tuple[str, str, str]]:
    """Enum attribute component."""
    # https://docs.blender.org/api/current/bpy.props.html#bpy.props.EnumProperty
    mat = context.object.active_material
    if mat is None:
        return []
...
def update_colormap_enum(self, context: bpy.types.Context) -> None:
    """Update colormap enum."""
    ...
    for i in range(n_colors):
        ...
        s_rgb = cmap(location)
        linear_rgb = [c**2.2 for c in s_rgb]
...
def update_attributes_enum(self, context: bpy.types.Context) -> None:
    """Update attributes enum."""
...
def show_scalar_bar(self, context: bpy.types.Context) -> None:
    """Show scalar bar."""
